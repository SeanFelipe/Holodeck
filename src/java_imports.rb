...
imports = [
  ...
  'graphics.g3d.attributes.TextureAttribute',
  ...
  'graphics.g3d.attributes.BlendingAttribute',                                                              'graphics.g3d.attributes.DepthTestAttribute',
  'graphics.g3d.attributes.IntAttribute',
